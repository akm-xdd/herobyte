            ...
            <div className="flex h-[100vh] items-center justify-center p-5 bg-cyan-600 w-full">
                <div className="flex items-center">
                    ...
                    <div className="text-left">
                        <h1 className="mt-5 text-4xl font-bold text-offpink lg:text-5xl font-primary">
                            ABOUT ME
                        </h1>
                        <p className="text-offpink mt-5 lg:text-lg font-secondary">
                            ...
                            <span className="text-3xl">Still have questions?</span> <br />
